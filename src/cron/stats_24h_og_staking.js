...
const stats_24h_og_staking = async ({ strapi }) => {
  console.log("[CRON TASK] 24H OG STAKING STATS");
  try {
  } catch (error) {
...
async function protocolFeeReceiverJob() {
  ...
  // await strapi.entityService.create("api::wen-og-pass-stat.wen-og-pass-stat",{data: {
  //   total_staked :
